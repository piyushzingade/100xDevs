            ...
            <div className="max-w-7xl w-full mx-auto px-6 lg:px-12 pt-24 lg:pt-32 pb-12 lg:pb-20">
                ...
                <div className="flex flex-col items-center text-center mb-16 lg:mb-20">
                    ...
                    <motion.div
                        ...
                        className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gray-900 border border-gray-800 text-[10px] lg:text-sm text-white/70 mb-6"
                    >
                ...
                >
                    ...
                    <div className="absolute -inset-4 bg-blue-500/20 blur-3xl rounded-lg opacity-50"></div>
                    <div className="absolute -inset-2 bg-blue-400/10 blur-2xl rounded-lg"></div>

                    {/* Dashboard container */}
                    <div className="relative rounded-lg border border-gray-800 bg-black overflow-hidden shadow-2xl">
                        ...
                        <div className="flex h-[400px] md:h-[600px]">
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-900 cursor-pointer group">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <p className="text-sm text-white font-medium truncate">React</p>
                                        ...
                                        <div className="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-900 cursor-pointer group">
                                            <MessageSquare className="w-4 h-4 text-white/40 group-hover:text-blue-400" />
                                            <div className="flex-1 min-w-0">
                                                <p className="text-sm text-white font-medium truncate">Express</p>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-900 cursor-pointer group">
                                            <MessageSquare className="w-4 h-4 text-white/40 group-hover:text-blue-400" />
                                            <div className="flex-1 min-w-0">
                                                <p className="text-sm text-white font-medium truncate">AWS</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            {/* Main Content Area */}
                            <div className="flex-1 flex flex-col bg-[#0b0d10]">
                                {/* Top Bar */}
                                ...
                                {/* Image Content Area */}
                                <div className="flex-1 relative overflow-hidden bg-[#0b0d10]">
                                    <Image
                                        src="/dashboard.png"
